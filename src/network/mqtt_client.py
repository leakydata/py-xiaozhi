...
class MqttClient:
    def __init__(
        ...
        :param on_connect: Custom connect callback function
        ...
        # Set callback functions, use custom callbacks if provided, otherwise use defaults
        if on_connect:
    ...
    def _on_connect(self, client, userdata, flags, rc, properties=None):
        """
        Default connect callback function.
        """
        if rc == 0:
            print("✅ Successfully connected to MQTT server")
            # Automatically subscribe to the topic after successful connection
    ...
    def start(self):
        """
        Start the client and begin the network loop.
        """
...
if __name__ == "__main__":
    ...
    #
    # # Create MqttClient instance with custom callback functions
    ...
    # )
    #
    # # Pass subscription topic information to the callback function as user data
